...
public class ByteBufferUsage {
    ...
    public static void main(String[] args) {
        ...
        final int SHIFT = 30;
        System.out.println();
        System.out.println(0x3<<SHIFT);
        System.out.println(1<<SHIFT);
        System.out.println(2<<SHIFT);
        System.out.println((byte)0x3<<SHIFT);
        System.out.println((byte)1<<SHIFT);
        System.out.println((byte)2<<SHIFT);
//        System.out.println(Byte.valueOf(0x3<<SHIFT));
//        System.out.println(Byte.valueOf(1<<SHIFT));
//        System.out.println(Byte.valueOf(2<<SHIFT));
    }
}
