...
public class UDPEchoWithChannels {
...
//        SocketAddress remote = new InetSocketAddress("www.baidu.com", port);
        SocketAddress remote = new InetSocketAddress("www.sina.com.cn", port);
//        try {
